...
import { AllPrices, Crypto, DescriptionInfo } from "../types/Crypto";
...
export default function Prices() {
  ...
  return (
    <div className="inline-flex w-full">
      <div className="mt-[25px] h-auto w-1/2 flex-col items-center rounded-3xl bg-black bg-opacity-20">
        ...
        {currentPrices.after.map((currentCrypto, index) => {
          ...
          return (
            ...
            >
              <motion.div
                className="flex h-[50px] w-full cursor-pointer items-center justify-between px-5 hover:bg-red-400"
                onClick={() => {
                  setDescription({
      ...
      {description && (
        <div className="ml-5 mt-5 h-[300px] w-1/2 rounded-3xl bg-black bg-opacity-20 p-5">
